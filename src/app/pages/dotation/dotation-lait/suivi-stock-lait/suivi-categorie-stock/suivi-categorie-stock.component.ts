...
import { AddOrUpdateStockLaitComponent } from '../../stock-lait/add-or-update-stock-lait/add-or-update-stock-lait.component';
...
@Component({
  selector: 'fury-suivi-categorie-stock',
  templateUrl: './suivi-categorie-stock.component.html',
  styleUrls: ['./suivi-categorie-stock.component.scss','../../../../../shared/util/bootstrap4.css'],
  animations: [fadeInRightAnimation, fadeInUpAnimation]
})
export class SuiviCategorieStockComponent implements OnInit {
  ...
  columns: ListColumn[] = [
    ...
    { name: "Libelle", property: "libelle", visible: false, isModelProperty: true },
  ...
  getSuiviStocks() {
    this.suiviStockService.getAll().subscribe(
      (response) => {
        ...
        this.suiviStocksCat1= this.suiviStocks.filter(s => s.categorieLait.libelle === 'NAN 1');
        this.suiviStocksCat2= this.suiviStocks.filter(s => s.categorieLait.libelle === 'NAN 2');
        this.suiviStocksCat3= this.suiviStocks.filter(s => s.categorieLait.libelle === 'NAN 3');
        
        console.log('cat 1=> '+this.suiviStocksCat1);
        console.log('cat 2=> '+this.suiviStocksCat2);
        console.log('cat 3=> '+this.suiviStocksCat3);
