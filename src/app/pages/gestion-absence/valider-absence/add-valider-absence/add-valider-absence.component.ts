...
@Component({
  selector: 'fury-add-valider-absence',
  templateUrl: './add-valider-absence.component.html',
  styleUrls: ['./add-valider-absence.component.scss']
})
export class AddValiderAbsenceComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AddValiderAbsenceComponent>,
  ...
  updateAbsenceValider() {
    let  etapeAbsence: EtapeAbsence;
      ...
      this.absence.etape = this.agent.uniteOrganisationnelle.description;
      ...
      this.absence.etat = this.etatAbsence.valider;
