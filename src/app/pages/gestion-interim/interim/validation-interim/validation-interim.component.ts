...
@Component({
  selector: 'fury-validation-interim',
  templateUrl: './validation-interim.component.html',
  styleUrls: ['./validation-interim.component.scss']
})
export class ValidationInterimComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<ValidationInterimComponent>,
