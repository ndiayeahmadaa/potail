...
export let textWrapData = [
    {
      ...
      inferieures: [
          { 
              ID: 2, 
              CODE: 'DD', 
              NOM: "Direction du Digital",
              DESCRIPTION: "Direction du Digital", 
              NIVEAU: 2,
              inferieures: [
                  { ID: 3, CODE: 'DIRS', NOM: "Division Infrastructures Réseaux et Systèmes", DESCRIPTION: "Division Infrastructures Réseaux et Systèmes", NIVEAU: 3 },
                  { ID: 3, CODE: 'DSE', NOM: "Division Support et Exploitation", DESCRIPTION: "Division Support et Exploitation", NIVEAU: 3 },
              ]
            },     
         ]
    },
