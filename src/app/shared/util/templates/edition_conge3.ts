...
import { Conge } from "../../../pages/gestion-conge/shared/model/conge.model";
...
export let genererPDF = function (conge:Conge) {
...
//   let titreDCH = "";
//   if(attestation.directeurSectorielDCH.sexe){
//     titreDCH = attestation.directeurSectorielDCH.sexe.toLowerCase() == 'm' ? 'M' : attestation.directeurSectorielDCH.matrimoniale.toLowerCase() == 'marié(e)' ? 'Mme' : 'Mlle'
//  }
  /*let pronom = "";
  ...
  if(attestation.fonctionDemandeur){
    debut = attestation.fonctionDemandeur.startsWith('A'||'O'||'E'||'Y'||'I'||'U'||'a'||'o'||'i'||'e'||'y'||'I') ? 'd\'' : 'de'
  }
  ...
  let prenomTr;
   if(suiviAttestation!=null){
    nomTr = suiviAttestation.nom
    prenomTr = suiviAttestation.prenom
  }*/
  ...
  var docDefinition = {
    content: [
      ...
      },
      {
        ...
        table: {
          ...
          body: [
            ...
            [{text: 'Attestation de travail', margin: [8, 10, 0, 8],fontSize: 20}],
          ]
        }
      },
      {
     ...
     /* {
        ...
        fontSize: 13, 
        text: [
          { text: 'L', bold: true },'e ', { text: 'D', bold: true },'irecteur ', { text: 'G', bold: true },'énéral du ', 
          { text: 'P', bold: true },'ort ', { text: 'A', bold: true },'utonome de ', { text: 'D', bold: true },'akar, soussigné, atteste que '
          // 'Le Directeur Général du Port autonome de Dakar, soussigné atteste que ' 
        , {text : titre + ' ' + prenom + ' ' + nom , bold : true}, 
        ' matricule de solde ' ,{text : matricule, bold :true}, ', né(e) le ' ,{text : dateNaissance, bold :true}, ' à ' ,{text : lieuNaissance, bold :true},
        ', est employé par notre socièté depuis le ',{text : dateEngagement, bold :true},'.\n\n' ,{text : pronom }, ' ocuppe la fonction ' ,{text : debut},' ', {text : fonction, bold :true},' à la ',{text : direction, bold :true}, ' En foi de quoi',
      ...
      },*/
     {
     ...
     },
      {
        ...
        text: [
          { text: 'P', bold: true }, 'our ', { text: 'L', bold: true }, 'e ', { text: 'D', bold: true }, 'irecteur ', { text: 'G', bold: true }, 'énéral ',
          { text: 'et par ordre,\n'}, '   ' ,{text:'\tle',margin: [220, 15, 0, 0]}, ' ' ,{ text: 'D', bold: true }, 'irecteur du ',{ text: 'C', bold: true },'apital ',{ text: 'H', bold: true }, 'umain.' 
